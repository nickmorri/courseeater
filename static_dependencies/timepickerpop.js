...
angular.module('timepickerPop', [ 'ui.bootstrap' ])
	...
	return {
		...
		$document.bind('click', function(event) {
            ...
            template : "<div class='input-group-btn' ng-class='{open:isOpen}'> "
            ...
            + "</div></div>"
            + "<input type='text' class='form-control' ng-model='inputTime' ng-disabled='disabledInt' time-format show-meridian='showMeridian' ng-focus='open()' placeholder='Time'/>"
	};
    });