(function () {
    ...
    var module_dependencies = ['courseeater.course', 'courseeater.list', 'courseeater.alert', 'ui.bootstrap', 'angular.filter', 'jp.ng-bs-animated-button'];

    angular
        .module('courseeater.track', module_dependencies)
        .controller('CourseSearchModalController', CourseSearchModalController)
        .controller('TrackController', TrackController);

    CourseSearchModalController.$inject = ['$scope', 'CourseStore', 'TemporaryStore', '$modalInstance', 'ButtonConfiguration'];
    function CourseSearchModalController ($scope, CourseStore, TemporaryStore, $modalInstance, ButtonConfiguration) {
    ...
    TrackController.$inject = ['$scope', 'CourseListStore', 'CourseStore', 'TemporaryStore', 'AlertStore', '$modal', 'ButtonConfiguration'];
