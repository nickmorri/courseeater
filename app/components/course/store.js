(function () {
   "use strict";
    ...
    var modules_dependencies = ['courseeater.course', 'ui.bootstrap'];

    angular
        .module('courseeater.store', modules_dependencies)
        .factory('TemporaryStore', TemporaryStore)
        .factory('CourseStore', CourseStore)
        .filter('section', SectionFilter);

    TemporaryStore.$inject = ['Course'];
    function TemporaryStore (Course) {
        var TemporaryStore = {};
        ...
        TemporaryStore.addCourse = function (course, replacement) {
            (new Course(course.courseCode, course.term, "black")).deferred.promise
                .then(function (fetched_course) {
    ...
    CourseStore.$inject = ['Course', '$rootScope'];
    function CourseStore (Course, $rootScope) {
        var CourseStore = {};
