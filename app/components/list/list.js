(function () {
    ...
    function CourseListModalController ($scope, CourseListStore, Retriever, AlertStore, list) {
        ...
        $scope.saveList = function () {
            $scope.isSaving = true;
            $scope.courseListStore.saveList($scope.list.id, $scope.list.title, $scope.list.term).catch(function (error) {
        ...
        $scope.deleteList = function () {
            ...
            $scope.courseListStore.deleteList($scope.list.id).catch(function (error) {
                if (error.message) {
