(function () {
    ...
    var module_dependencies = ['courseeater.course', 'courseeater.list', 'ui.bootstrap', 'ui.calendar'];

    angular
        .module('courseeater.schedule', module_dependencies)
        .run(ScheduleRun)
        .controller('ScheduleController', ScheduleController)
        .controller('FinalScheduleController', FinalScheduleController)
        .controller('CourseScheduleModalController', CourseScheduleModalController)
        .directive('scheduleToolbar', ScheduleToolbar)

    ScheduleRun.$inject = ['CourseListStore'];
    function ScheduleRun (CourseListStore) {
        if (!CourseListStore.initialized) {
            CourseListStore.retrieveCourseLists();
        }
    }

    ScheduleController.$inject = ['$scope', 'CourseStore', 'CourseListStore', 'TemporaryStore', 'uiCalendarConfig', '$modal'];
    ...
    FinalScheduleController.$inject = ['$scope', 'CourseStore', 'CourseListStore', 'TemporaryStore', 'uiCalendarConfig', '$modal'];
    ...
    CourseScheduleModalController.$inject = ['$scope', '$modal', '$modalInstance', 'CourseStore', 'TemporaryStore', 'ButtonConfiguration', 'course'];
