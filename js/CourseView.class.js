...
var getCourseInfo, getCourseName, getCourseReqs, getCourseDays, getCourseLocation, getCourseProgress, getCourseTime, getCourseInstructor, getCourseActions, buildPanel, buildSubPanel, buildCourse;
...
CourseView.prototype.getCourseInfo = function () {
    ...
    infoString += '</span>';
    infoString += this.getCourseReqs();
    infoString += ' <span class="badge pull-right course-view-courseID">';
